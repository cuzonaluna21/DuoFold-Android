...
final class MipScreen {
    ...
    void update(int external,float[] transform,int w,int h,FloatBuffer quad,int viewW,int viewH) {
        ...
        if(texture==0 || sourceWidth!=w || sourceHeight!=h) {
            ...
            // ES 2 only guarantees mipmaps on power-of-two textures without this extension.
            ...
            if(width>limit[0] || height>limit[0])throw new IllegalStateException("Screen exceeds GPU texture size");
            ...
            if(GLES20.glCheckFramebufferStatus(GLES20.GL_FRAMEBUFFER)!=GLES20.GL_FRAMEBUFFER_COMPLETE) {
                ...
                throw new IllegalStateException("Cannot prepare lens texture");
            }
        }
        try {
            GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER,framebuffer);
            ...
            if(error!=GLES20.GL_NO_ERROR)throw new IllegalStateException("Lens texture GL error "+error);
        } finally {
            GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER,0);
